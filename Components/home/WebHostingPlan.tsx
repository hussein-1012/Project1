...
{
  return (
    <div className='flex flex-col items-center justify-center w-3/4 rounded p-4 bg-gray-200
      mb-7 md:w-2/4 lg:w-1/4 '>
        <h3 className='text-3xl font-bold text-purple-900'>Premium</h3>
        <strong  className='text-3xl font-bold text-gray-900 my-5'>$7.99 </strong>
        ...
        <button className="mt-4 border-2 border-gray-900 text-gray-900 text-2xl font-bold p-1 rounded-full 
        hover:text-white hover:bg-gray-900 transition w-full ">
          BUY NOW
        </button>
    </div>
  )
