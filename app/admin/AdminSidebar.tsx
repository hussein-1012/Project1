...
const AdminSidebar = () => {
  ...
  <>
    ...
    <ul className='mt-10 flex items-center justify-center flex-col lg:items-start'>
      <Link href='/admin/Articles-table' className='flex items-center text-xl mb-5 
      lg:border-b bg-black hover:border-yellow-200 hover:text-yellow-200 translate'>
        <MdOutlineArticle className='me-1 '/>
        <span className='hidden lg:block '>Articles.</span>
      </Link>
       
      <Link href='/admin/Comments-table' className='flex items-center text-xl mb-5 
      lg:border-b bg-black hover:border-yellow-200 hover:text-yellow-200 translate'>
